...
- BRANDING_SHEET → full brand identity overview sheet, portrait orientation. Composed as a single image showing: (1) a logo + tagline at the top, (2) 2–3 logo variants (icon-only, stacked, monochrome), (3) a horizontal color palette of 5–7 swatches with hex codes below each, (4) 2–3 application mockups at the bottom (product detail shot, packaging/tag, embroidered or debossed application). Layout is gridded and information-dense like a brand-style-guide poster. Background: warm off-white (#F4F2EE) or muted ink. Typography is the deck's serif/sans pairing. Render the logo and palette as crisp design artifacts, not photographs of them. Mockups can be photographic. The whole sheet reads like a one-page deliverable from a brand identity firm (Pentagram, COLLINS, Mucca Design). Include short section labels in monospaced ALL-CAPS (PRIMARY LOGO, COLOR PALETTE, APPLICATION MOCKUPS).
